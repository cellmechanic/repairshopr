...
from library.db_requests_library import connect_to_db, create_customer_table_if_not_exists, compare_id_sums, \
    insert_customers, move_deleted_customers_to_deleted_table
